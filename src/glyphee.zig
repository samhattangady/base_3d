...
pub const TypeSetter = struct {
    ...
    pub fn init(self: *Self, camera: *const Camera2D, allocator: std.mem.Allocator) !void {
    ...
    pub fn draw_char(self: *Self, pos: Vector2, char: u8, camera: *const Camera2D) Vector2 {
        return self.draw_char_color(pos, char, 0.9, camera, BLACK);
    }

    pub fn draw_char_color(self: *Self, pos: Vector2, char: u8, z: f32, camera: *const Camera2D, color: Vector4_gl) Vector2 {
    ...
    pub fn draw_char_color_font(self: *Self, pos: Vector2, char: u8, z: f32, camera: *const Camera2D, color: Vector4_gl, font: FontType) Vector2 {
        _ = z;
    ...
    pub fn draw_text_width_camera(self: *Self, pos: Vector2, text: []const u8, width: f32, camera: *const Camera2D) void {
    ...
    pub fn draw_text(self: *Self, pos: Vector2, text: []const u8, camera: *const Camera2D) void {
        self.draw_text_width(pos, text, camera, 1000000.0);
    }

    pub fn draw_text_width(self: *Self, pos: Vector2, text: []const u8, camera: *const Camera2D, width: f32) void {
    ...
    pub fn draw_text_width_font(self: *Self, pos: Vector2, text: []const u8, camera: *const Camera2D, width: f32, font: FontType) void {
        self.draw_text_width_color_font(pos, text, camera, width, BLACK, font);
    }

    pub fn draw_text_width_color(self: *Self, pos: Vector2, text: []const u8, camera: *const Camera2D, width: f32, color: Vector4_gl) void {
        self.draw_text_width_color_font(pos, text, camera, width, color, DEFAULT_FONT);
    }

    pub fn draw_text_width_color_font(self: *Self, pos: Vector2, text: []const u8, camera: *const Camera2D, width: f32, color: Vector4_gl, font: FontType) void {
        var offsets = Vector2{};
        var new_line = false;
        for (text) |char| {
    ...
    pub fn get_text_offset(self: *Self, text: []const u8, width: f32, camera: *const Camera2D) Vector2 {
        var offsets = Vector2{};
        var new_line = false;
        for (text) |char| {
    ...
    pub fn get_text_bounding_box(self: *Self, text: []const u8, width: f32, camera: *const Camera2D) Vector2 {
        var num_lines: f32 = 1;
        var offsets = Vector2{};
        var new_line = false;
        for (text) |char| {
